package com
{
	...
	public class dinopg15 extends MovieClip
	{
		...
		public function dinopg15()
		{
			container.play();
			infoBoxContainer = new page_18;
			infoBoxContainer.x = -450;
			infoBoxContainer.y = -235;
		...
		public function egg1Ftn(event:MouseEvent):void
		{
			container.dino1.play();
			container.egg1.play();
		}
		
		public function egg2Ftn(event:MouseEvent):void
		{
			container.dino2.play();
			container.egg2.play();
		}
		
		public function egg3Ftn(event:MouseEvent):void
		{
		...
		{
			container.egg1.addEventListener(MouseEvent.CLICK,egg1Ftn);
			container.egg2.addEventListener(MouseEvent.CLICK,egg2Ftn);
			container.egg3.addEventListener(MouseEvent.CLICK,egg3Ftn);
			container.cabinet.addEventListener(MouseEvent.CLICK,playFtn);
