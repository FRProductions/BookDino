package com
{
	...
	public class dinopg11 extends MovieClip
	{
		...
		public function dinopg11()
		{
			container.play();
			infoBoxContainer = new page_14;
			infoBoxContainer.x = 465;
			infoBoxContainer.y = 175;
		...
		{
			container.dino1.addEventListener(MouseEvent.CLICK,dinoFtn);
			container.dino1.dino2.addEventListener(MouseEvent.CLICK,dinoFtn);
