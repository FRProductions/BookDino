package com
{
	...
	public class dinopg18 extends MovieClip
	{
		...
		public function dinopg18()
		{
			//container.play();
			infoBoxContainer = new page_21;
			infoBoxContainer.x = 65;
		...
		public function busFtn(event:MouseEvent):void
		{
			container.fred.play();
		}
		...
		{
			container.bus.addEventListener(MouseEvent.CLICK,busFtn);
			container.tree.addEventListener(MouseEvent.CLICK,dinoFtn);
